...
export default function About() {
  return (
    <div className="flex flex-col p-5 max-w-6xl mx-auto md:items-start items-center md:px-0">
      <h1 className="xl:text-4xl text-2xl font-semibold text-emerald-500 md:mb-0 mb-2">
        About Me
      </h1>
      <div
        className="md:hidden shrink-0  h-[150px] w-[150px] md:translate-x-0 md:h-[170px] md:w-[170px] rounded-[20%] 
        bg-cover bg-center bg-no-repeat border-3 border-emerald-500 md:shadow-md shadow-sm shadow-emerald-deep md:mb-0 mb-4
    "
        style={{
      ...
      />
      <p className="text-emerald-500 text-lg text-center">
        Building accessible, user-friendly interfaces with TypeScript and React.
      </p>

      <div className="max-w-5xl">
        <div className="mt-5 md:mt-2 md:mb-5 mb-8 md:text-start text-center md:px-0 px-8 ">
          ...
          <div className="flex flex-row gap-8 items-start">
            ...
            <div
              className="hidden md:block shrink-0 -mt-25 h-[100px] w-[100px] md:translate-x-0 md:h-[170px] md:w-[170px] rounded-[20%] 
        bg-cover bg-center bg-no-repeat border-3 border-emerald-500 md:shadow-md shadow-sm shadow-emerald-deep md:mb-0 mb-4
    "
              style={{
                backgroundImage: `url(${profilePhoto.src})`,
        ...
        <div className="md:text-start text-center md:px-0 px-8">
        ...
        <div className="mb-10 text-center md:text-start md:px-0 px-8">
          <h2 className="font-semibold text-xl text-emerald-500 md:mb-0 mb-1">
            Core skills
          </h2>
